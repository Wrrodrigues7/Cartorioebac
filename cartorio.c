...
int registro() //Função responsavel por cadastrar os usúarios no sistema
{
	...
	printf("Digitr o CPF a ser cadastrado: "); //coletando informação do usuário 
	...
	printf("Digite p cargo a ser cadastrado: ");
	scanf("%s", cargo);
...
{   
	...
	for(laco=1;laco=1;)	
	{
        ...
        switch(opcao)//inicio da seleção do menu
        {
			...
			case 2:
			consulta();// chamada para consulta
			break;
			
			case 3:	
			deletar();// chamada para deletar
    	    break;
